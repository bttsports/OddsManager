...
SCRIPT_NAME="combined_no_KXTX02R_26.py"
SERVICE_NAME="oddsmanager-combinedno-kxtx02r26"

PYTHON="${PYTHON:-/home/your_user/venvs/myenv1/bin/python}"
SCRIPT_PATH="${PROJECT_ROOT}/market_making/combined_no_KXTX02R_26.py"
...
[Unit]
Description=OddsManager Combined No - KXTX02R-26
