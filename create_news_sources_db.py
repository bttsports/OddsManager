...
def main():
    ...
    """)
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS mlb_tweets_all (
          id            INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
          tweet_id      VARCHAR(32)   NOT NULL COMMENT 'Twitter tweet ID',
          author_handle VARCHAR(255)  NOT NULL,
          text          TEXT          NOT NULL,
    ...
    """)
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS golf_tweets (
          id            INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
          tweet_id      VARCHAR(32)   NOT NULL COMMENT 'Twitter tweet ID',
          author_handle VARCHAR(255)  NOT NULL,
          text          TEXT          NOT NULL,
    ...
    cursor.close()
    conn.close()
    print("Database 'news_sources' and tables 'mlb_tweets', 'mlb_tweets_all', 'golf_tweets' are ready.")
